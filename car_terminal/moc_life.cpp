...
QT_MOC_LITERAL(1, 5, 14), // "hide_show_life"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 27) // "on_pushButton_photo_clicked"

    },
    "Life\0hide_show_life\0\0on_pushButton_photo_clicked"
};
...
void Life::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hide_show_life(); break;
        case 1: _t->on_pushButton_photo_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (Life::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Life::hide_show_life)) {
                *result = 0;
                return;
            }
        }
