...
QT_MOC_LITERAL(1, 10, 26), // "getCurrentPageIndexChanged"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 22), // "hScrollBarValueChanged"
QT_MOC_LITERAL(4, 61, 14), // "onStateChanged"
QT_MOC_LITERAL(5, 76, 16), // "QScroller::State"
QT_MOC_LITERAL(6, 93, 14), // "onTimerTimeOut"
QT_MOC_LITERAL(7, 108, 25) // "onCurrentPageIndexChanged"

    },
    "SlidePage\0getCurrentPageIndexChanged\0"
    "\0hScrollBarValueChanged\0onStateChanged\0"
...
void SlidePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getCurrentPageIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SlidePage::getCurrentPageIndexChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SlidePage::getCurrentPageIndexChanged(int _t1)
{
