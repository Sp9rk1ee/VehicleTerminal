...
QT_MOC_LITERAL(1, 6, 10), // "Line_alter"
...
void Lyric::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Lyric *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Line_alter((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Lyric::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Lyric::Line_alter)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Lyric::Line_alter(qint64 _t1)
{
